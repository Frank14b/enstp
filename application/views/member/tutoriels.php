...
<div class="view zoom card" style="width:100%; height:230px">
    ...
    <div class="mask pattern-3 flex-center waves-effect waves-light">
        <p class="white-text" style="font-size: 2.3em">" Tutoriels "</p>
    </div>
</div>
                  </div>
                </div>
            ...
            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
              <?php 
                ...
                <div class="table-heading px-2 px-1 border-bottom">
                  <h1 class="mdc-card__title mdc-card__title--large">Liste des Tutos Ajoutes</h1>
                  <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addExos">Nouveau Tutoriel</button>
                </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                      ...
                      foreach($val as $row):
                        ?>
                    <tr>
                      <td class="text-left"><button class="col mdc-button" data-mdc-auto-init="MDCRipple"><i class="mdi mdi-delete text-blue"></i></button></td>
                      <td><?= $row->libeller ?></td>
                      <td><?= $CI->matieres->getOneData($row->Mat_id,'libeller') ?></td>
                      <td><?= $row->dates ?></td>
                      <td><button class="col mdc-button" data-mdc-auto-init="MDCRipple"><i class="mdi mdi-delete text-red"></i></button></td>
                    </tr>
                    <?php 
                      endforeach;
                    ?>
